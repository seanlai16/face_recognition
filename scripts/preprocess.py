...
align_dlib = AlignDlib(os.path.join(os.path.dirname(model_dir), 'shape_predictor_68_face_landmarks.dat'))
...
# Change the defaults for input and output dir to suit your needs
if __name__ == '__main__':
    logging.basicConfig(level=logging.INFO)
    parser = argparse.ArgumentParser(add_help=True)
    parser.add_argument('--input-dir', type=str, action='store', default='../training_data', dest='input_dir')
    parser.add_argument('--output-dir', type=str, action='store', default='../preprocessed_data', dest='output_dir')
